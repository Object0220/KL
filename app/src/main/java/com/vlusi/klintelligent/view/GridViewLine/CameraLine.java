package com.vlusi.klintelligent.view.GridViewLine;
...
public class CameraLine extends View {
    ...
    public void changeLineStyle(int i) {
        switch (i) {
            case LINE_STYLE_HIDE_LINE:  //隐藏线
                nowLineStyle = LINE_STYLE_SHOW_LINES;
                lineIsWide = true;
                showLines = true;
                break;
            case LINE_STYLE_SHOW_LINES: //线
                nowLineStyle = LINE_STYLE_SHOW_LINES_LINE_IS_WIDE;
                lineIsWide = false;
                showLines = true;
                break;
            case LINE_STYLE_SHOW_LINES_LINE_IS_WIDE:  //宽线
    ...
    protected void onDraw(Canvas canvas) {
        if (showLines) {
            int screenWidth = Utils.getScreenWH(getContext()).widthPixels; //屏幕的宽度
            int screenHeight = Utils.getScreenWH(getContext()).heightPixels; //屏幕的高度
